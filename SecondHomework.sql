...
SELECT * FROM film WHERE replacement_cost BETWEEN 12.99 AND 16.98; -- 16.99'dan küçük eşit değil de küçük olması istenildiği için 16.98 yazdım.
...
SELECT * FROM film WHERE rental_rate IN (0.99,2.99,4.99) AND replacement_cost IN (28.99,12.99,15.99);